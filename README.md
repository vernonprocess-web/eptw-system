...
npx wrangler d1 execute master-rams-db --local --file=./add_users.sql
npx wrangler d1 execute master-rams-db --local --file=./add_ptw.sql
npx wrangler d1 execute master-rams-db --local --file=./add_tbm.sql
...
npx wrangler d1 execute master-rams-db --local --file=./update_schema_phase5.sql
```
